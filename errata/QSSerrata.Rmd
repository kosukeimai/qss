...
* page 209, first paragraph.  Add the following sentence to the end of the paragraph, "If a node is not connected to any other node, then the number of nodes in the graph, i.e., 16 in this case, is used instead of the length of the shortest path.  Thus, Pucci family's closeness is equal to $1 / (15 \times 16)$
"
...
* page 221, first paragraph. Change "River Thames (indicated by the blue region)" to "River Thames (indicated by the red region)".  Change "further south (indicated by the red region)" to "further south (indicated by the blue region)".
